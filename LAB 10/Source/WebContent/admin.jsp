...
<body>
	...
	%>
	<br/><br/>
  <h1 style="margin-bottom: 10px; text-align: center; font-family:calibri;font-size:50px;color:white;font-style:italic;">Welcome </h1>
	<div class="wrap" style="width: 90%;">
		<br/>
					...
					<br/><br/>
							<h2 style="font-family:Cambria;font-size:24px;font-stype:italic" align="right"><a href="signup.jsp" style="color:white"><u> Add new employee!!!!</u></a></h2>
					<br/><br/>
					<div class="clear"></div>
